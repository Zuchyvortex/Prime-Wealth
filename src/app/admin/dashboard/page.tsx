    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass rounded-2xl p-6 relative overflow-hidden">
          ...
          <p className="text-[10px] text-purple-400 mt-2 font-mono flex items-center gap-1">
            ...
            {mounted ? (
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar dataKey="Deposits" fill="#8b5cf6" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="Withdrawals" fill="#6366f1" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            ) : (
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="p-3 bg-white/3 border border-white/5 rounded-xl flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 text-[8px] font-bold bg-purple-500/10 text-purple-400 rounded uppercase">online</span>
              </div>
              ...
              <div className="p-3 bg-white/3 border border-white/5 rounded-xl flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 text-[8px] font-bold bg-indigo-500/10 text-indigo-400 rounded uppercase">normal</span>
              </div>
              ...
              <div className="p-3 bg-white/3 border border-white/5 rounded-xl flex items-center justify-between">
                ...
                <span className="px-2 py-0.5 text-[8px] font-bold bg-violet-500/10 text-violet-400 rounded uppercase">stable</span>
              </div>
            </div>
          </div>
